...
public class ZXingCode {
    ...
    public static String getLogoQRCode(String qrUrl, String productName) {
        //      String filePath = (javax.servlet.http.HttpServletRequest)request.getSession().getServletContext()
        // .getRealPath("/") + "resources/images/logoImages/llhlogo.png";
        //filePath是二维码logo的路径，但是实际中我们是放在项目的某个路径下面的，所以路径用上面的，把下面的注释就好
        String filePath = "C:/Users/wb-whz291815/Desktop/logo.png";  //TODO
    ...
    public String addLogo_QRCode(BufferedImage bim, File logoPic, LogoConfig logoConfig, String productName) {
        try {
            ...
            ImageIO.write(image, "png",
                new File("C:/Users/wb-whz291815/Desktop/TDC-" + new Date().getTime() + "test.png")); //TODO
